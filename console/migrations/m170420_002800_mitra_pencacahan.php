...
class m170420_002800_mitra_pencacahan extends Migration {
    ...
    public function up() {
        ...
        $this->createTable('{{%mitra_pencacahan}}', [
            'id' => $this->primaryKey(),
        ...
        $this->createIndex(
                'idx_mitra_c_kdpendidikan', 'mitra_pencacahan', 'kdpendidikan'
        );
        $this->addForeignKey(
                'fk_kdpendidikan', 'mitra_pencacahan', 'kdpendidikan', 'master_pendidikan', 'kdpendidikan', 'CASCADE'
        );
       
    }

    public function down() {
        $this->dropTable('{{%mitra_pencacahan}}');
    }
