...
<div class="col-lg-4 col-md-6 text-center">
    <div class="card<?php if ($model->sedang_survei){echo " "."bgred";}?>">
        <div class="icon-block card-content">          
            ...
            <p class="text-muted"><?= $model->pekerjaan; ?></p>
             <p class="text-muted">Status:<?= $model->status; ?></p>
            <p class="text-muted"><?php if($model->android==1){echo "Punya Android";}else{echo "Tidak Punya Android";}?></p>
            <p class="text-muted">
                <?php
                if ($model->jk == '2') {
                    echo "Perempuan";
