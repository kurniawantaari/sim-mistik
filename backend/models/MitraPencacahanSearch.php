...
/**
 * MitraPencacahanSearch represents the model behind the search form about `backend\models\MitraPencacahan`.
 */
class MitraPencacahanSearch extends MitraPencacahan {
    ...
    public function search($params) {
        $query = MitraPencacahan::find();//->joinWith(['kegiatan']);
