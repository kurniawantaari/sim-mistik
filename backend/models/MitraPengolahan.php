...
/**
 * This is the model class for table "mitra_pengolahan".
 *
 * @property integer $id
 * @property string $nik
 ...
 */
class MitraPengolahan extends \yii\db\ActiveRecord {
...
//              checks if "file" to be imported is a valid image with proper size
    ...
    public function getNilaiPengolahans() {
        return $this->hasMany(NilaiPengolahan::className(), ['idmitra' => 'id']);
    }

    /**
     * @inheritdoc
     * @return MitraPengolahanQuery the active query used by this AR class.
     */
    public static function find() {
        return new MitraPengolahanQuery(get_called_class());
    }
